...
export default function EmailAccounts() {
  ...
  const [emailInput, setEmailInput] = useState('bhavinmali1810@gmail.com');
            ...
            <tbody>
              <tr style={{ borderBottom: '1px solid #F3F4F6' }}>
                <td style={{ padding: '1.25rem 0' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <span style={{ fontWeight: 500, color: '#111827' }}>hiring@stackforce.co</span>
                    <span style={{ fontSize: '0.7rem', background: '#F5F3FF', color: '#7C3AED', padding: '0.1rem 0.4rem', borderRadius: '4px', fontWeight: 600 }}>🎁 Free</span>
                  </div>
                  <div style={{ fontSize: '0.75rem', color: '#9CA3AF', marginTop: '0.2rem' }}>
                    Signed as "Team Stackforce" · 10 emails/day
                  </div>
                </td>
                <td style={{ padding: '1.25rem 0', color: '#111827', fontWeight: 500 }}>10</td>
                <td style={{ padding: '1.25rem 0', color: '#4F46E5', fontWeight: 500 }}>Always Active</td>
                <td style={{ padding: '1.25rem 0', color: '#9CA3AF' }}>-</td>
              </tr>
            </tbody>
          </table>
              ...
              <div style={{ marginTop: '1.5rem' }}>
                ...
                <div style={{ border: '1px solid #F3F4F6', borderRadius: '8px', padding: '1.25rem', marginBottom: '1.5rem' }}>
                  ...
                  <ol style={{ paddingLeft: '1.25rem', margin: 0, color: '#6B7280', fontSize: '0.875rem', lineHeight: 1.8 }}>
                    ...
                    <li>Log in and enter an app name of your choice (eg. Stackforce)</li>
                ...
                <div style={{ display: 'flex', gap: '0.75rem' }}>
                  ...
                  <button onClick={closeModal} style={{ flex: 1, padding: '0.7rem', border: 'none', background: '#A7B0F6', color: 'white', borderRadius: '6px', fontWeight: 600, cursor: 'pointer' }}>Connect Gmail</button>
                </div>
              </div>
            )}
          </div>
