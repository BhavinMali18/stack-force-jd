/**
 * Canonical tech skills dictionary for resume parsing.
 * Used to extract skills from raw resume text.
 * Phase 3: AI will replace this extraction step.
 */
...
const SKILL_DICTIONARY = [
  ...
  'openai', 'langchain', 'llm', 'hugging face', 'transformers',
  'mlflow', 'ray', 'optuna',
  ...
  'microservices', 'monorepo', 'serverless', 'event-driven', 'cqrs', 'event sourcing',
  ...
  'iot', 'embedded systems', 'arduino', 'raspberry pi', 'fpga', 'verilog',
